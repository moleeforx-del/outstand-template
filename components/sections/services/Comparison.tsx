            ...
            <div className={styles.table} data-border="true">
                ...
                <div className={styles.column2} data-border="true">
                  <div className={styles.tickIcon}>
                    <div className={styles.r32}>
                      <Image className={styles.r33} src="/assets/media/oUftBL1miexZcpuwoI9ULejss.svg" alt="Icon" width={100} height={100} />
                    </div>
                  </div>
                </div>
                <div className={styles.column2} data-border="true">
              ...
              <div className={styles.row2}>
                ...
                <div className={styles.column2} data-border="true">
                  <div className={styles.tickIcon}>
                    <div className={styles.r32}>
                      <Image className={styles.r33} src="/assets/media/SLuIZXA4KbIw2wd9hyqsEtWGDE.svg" alt="Icon" width={100} height={100} />
                    </div>
                  </div>
                </div>
                <div className={styles.column2} data-border="true">
