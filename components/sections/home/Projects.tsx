      ...
      <section className={styles.projects}>
              ...
              <div className={styles.tag} data-border="true">
                <div className={styles.icon}>
                  <div className={styles.r6}>
                    <Image className={styles.r7} src="/assets/media/Gffq0G9m0GW1yuXhPHoGM12o.svg" alt="Icon" width={20} height={20} />
                  </div>
                </div>
        ...
        <div className={styles.subContainer}>
          <div className={styles.r16}>
            <div className={styles.r1}>
              <div className={`${styles.r17} ${styles.onlyDesktop}`}>
                <div className={styles.openImage1} data-border="true">
                  <div className={styles.imageContainer} data-border="true">
                    <div className={styles.r20}>
                      <Image className={styles.r21} src="/assets/media/p3la5ETXsyJiUSfxQ2dV6kWdpVs.png" alt="Project Image" width={1092} height={758} />
                    </div>
                    <div className={styles.tabsContainer} data-border="true">
                      <div className={styles.image} data-border="true">
                        <div className={styles.r24}>
                          <Image className={styles.r25} src="/assets/media/p3la5ETXsyJiUSfxQ2dV6kWdpVs.png" alt="Project Image" width={76} height={52} />
                        </div>
                        <div className={styles.overlay} />
                      </div>
                      <div className={styles.image2}>
                        <div className={styles.r24}>
                          <Image className={styles.r28} src="/assets/media/gSsLnjt7WE1u50J7AUBNaOu1hc4.png" alt="Project Image" width={76} height={52} />
                        </div>
                        <div className={styles.overlay2} />
                      </div>
                      <div className={styles.image2}>
                        <div className={styles.r24}>
                          <Image className={styles.r28} src="/assets/media/v8DyMilEVADD4NQlYAGjnOPWyI.png" alt="Project Image" width={76} height={52} />
                        </div>
                        <div className={styles.overlay2} />
                      </div>
                    </div>
                ...
                <div className={styles.openImage1} data-border="true">
                  <div className={styles.imageContainer2} data-border="true">
                    ...
                    <div className={styles.tabsContainer} data-border="true">
                      <div className={styles.image} data-border="true">
                        <div className={styles.r24}>
                          <Image className={styles.r25} src="/assets/media/0YzCMxaSMGzVhwAth1njO5JLo.png" alt="Project Image" width={76} height={52} />
                        </div>
                        <div className={styles.overlay} />
                      </div>
                      <div className={styles.image2}>
                        <div className={styles.r24}>
                          <Image className={styles.r28} src="/assets/media/fcDvn8yazOfnipQ7d8kEHoqyCCU.png" alt="Project Image" width={76} height={52} />
                        </div>
                        <div className={styles.overlay2} />
                      </div>
                      <div className={styles.image2}>
                        <div className={styles.r24}>
                          <Image className={styles.r28} src="/assets/media/5eqo6wlEl53NuXGE2AApf7gzQ.png" alt="Project Image" width={76} height={52} />
                        </div>
                        <div className={styles.overlay2} />
                      </div>
                    </div>
              ...
              <div className={`${styles.r17} ${styles.onlyDesktop}`}>
                <div className={styles.openImage1} data-border="true">
                  <div className={styles.imageContainer} data-border="true">
                    <div className={styles.r20}>
                      <Image className={styles.r21} src="/assets/media/aanSMSnXl8oHQVUGs2YSODT7LhM.png" alt="Project Image" width={1092} height={758} />
                    </div>
                    <div className={styles.tabsContainer} data-border="true">
                      <div className={styles.image} data-border="true">
                        <div className={styles.r24}>
                          <Image className={styles.r25} src="/assets/media/aanSMSnXl8oHQVUGs2YSODT7LhM.png" alt="Project Image" width={76} height={52} />
                        </div>
                        <div className={styles.overlay} />
                      </div>
                      <div className={styles.image2}>
                        <div className={styles.r24}>
                          <Image className={styles.r28} src="/assets/media/fKqnzcAZ9UHiXKTmuu9wr1uWrhQ.png" alt="Project Image" width={76} height={52} />
                        </div>
                        <div className={styles.overlay2} />
                      </div>
                      <div className={styles.image2}>
                        <div className={styles.r24}>
                          <Image className={styles.r28} src="/assets/media/BWMfpmwUWSsbtO1tMPwOG6q0GN0.png" alt="Project Image" width={76} height={52} />
                        </div>
                        <div className={styles.overlay2} />
                      </div>
                    </div>
